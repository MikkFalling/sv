...
class AF2Player : AFBaseClass
{
	...
	void ExpansionInit()
	{
		RegisterCommand("player_teleportaim", "s", "(targets) - teleport target(s) to where you are aiming at", ACCESS_C, @AF2Player::teleportaim);
		RegisterCommand("say !tpaim", "s", "(targets) - teleport target(s) to where you are aiming at", ACCESS_C, @AF2Player::teleportaim, CMD_SUPRESS);
		RegisterCommand("player_teleportmeto", "s", "(target) - teleport you to target", ACCESS_C, @AF2Player::teleportmeto);
		RegisterCommand("say !tpmeto", "s", "(target) - teleport you to target", ACCESS_C, @AF2Player::teleportmeto, CMD_SUPRESS);
		RegisterCommand("player_teleporttome", "s", "(targets) - teleport target(s) to you", ACCESS_C, @AF2Player::teleporttome);
		RegisterCommand("say !tptome", "s", "(targets) - teleport target(s) to you", ACCESS_C, @AF2Player::teleporttome, CMD_SUPRESS);
		RegisterCommand("player_teleportpos", "sv", "(targets) (vector) - teleport target(s) to position", ACCESS_C, @AF2Player::teleportpos);
		...
		RegisterCommand("player_position", "s", "(target) - returns target position,", ACCESS_C, @AF2Player::position);
		RegisterCommand("say !position", "s", "(target) - returns target position,", ACCESS_C, @AF2Player::position, CMD_SUPRESS);
		RegisterCommand("player_resurrect", "s!b", "(targets) <0/1 no respawn> - resurrect target(s)", ACCESS_C, @AF2Player::resurrect);
		RegisterCommand("say !resurrect", "s!b", "(targets) <0/1 no respawn> - resurrect target(s)", ACCESS_C, @AF2Player::resurrect, CMD_SUPRESS);
		...
		RegisterCommand("player_noclip", "s!i", "(targets) <0/1 mode> - set target(s) noclip mode, don't define mode to toggle", ACCESS_C, @AF2Player::noclip);
		RegisterCommand("say !noclip", "s!i", "(targets) <0/1 mode> - set target(s) noclip mode, don't define mode to toggle", ACCESS_C, @AF2Player::noclip, CMD_SUPRESS);
		RegisterCommand("player_god", "s!i", "(targets) <0/1 mode> - set target(s) godmode, don't define mode to toggle", ACCESS_C, @AF2Player::god);
		RegisterCommand("say !god", "s!i", "(targets) <0/1 mode> - set target(s) godmode, don't define mode to toggle", ACCESS_C, @AF2Player::god, CMD_SUPRESS);
		...
		RegisterCommand("player_notarget", "s!i", "(targets) <0/1 mode> - set target(s) notarget, don't define mode to toggle", ACCESS_C, @AF2Player::notarget);
		RegisterCommand("say !notarget", "s!i", "(targets) <0/1 mode> - set target(s) notarget, don't define mode to toggle", ACCESS_C, @AF2Player::notarget, CMD_SUPRESS);
