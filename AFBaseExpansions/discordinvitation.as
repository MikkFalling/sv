...
class DiscordInvitation : AFBaseClass
{
	...
	void ExpansionInit()
	{
		@DiscordInvitation::g_cvarTimer = CCVar( "cvar_countdown", 1000, "- Time(sec) between each automatic message", ConCommandFlag::AdminOnly );
		@DiscordInvitation::g_cvarMsg = CCVar( "cvar_message", "Join our Discord Server: discord.gg/Dj9tcTfuM8", "- Message content for DiscordInvitation", ConCommandFlag::AdminOnly );
