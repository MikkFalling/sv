...
string V_MODEL = "models/ins2/wpn/f2000/v_f2000.mdl";
...
class weapon_ins2f2000 : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase
{
	...
	bool Deploy()
	{
		...
		{
			m_WasDrawn = true;
			return Deploy( V_MODEL, P_MODEL, DRAW_FIRST, "m16", GetBodygroup(), (45.0/30.0) );
		}
		else
			return Deploy( V_MODEL, P_MODEL, DRAW, "m16", GetBodygroup(), (15.0/22.0) );
	}
	...
	void Reload()
	{
		...
		{
			(self.m_iClip == 0) ? Reload( MAX_CLIP, RELOAD_EMPTY, (175.0/35.0), GetBodygroup() ) : Reload( MAX_CLIP, RELOAD, (105.0/32.0), GetBodygroup() );
			canReload = false;
		}
