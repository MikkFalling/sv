...
#include "../hunger/monsters/monster_th_cyberfranklin"
#include "../hunger/monsters/monster_th_boss"
...
void MapInit()
{
	...
	g_Ins2Menu.AddItem( BuyMenu::BuyableItem( "M1014 12 Gauge Ammo", INS2_M1014::GetAmmoName(), 45, "ammo", "shotgun" ) );
		//Saiga 12
	g_Ins2Menu.AddItem( BuyMenu::BuyableItem( "Saiga 12K", INS2_SAIGA12::GetName(), 700, "primary", "shotgun" ) );
