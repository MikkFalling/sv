// Insurgency's H&K G3A3
/* Model Credits
/ Model: Firearms Source team
/ Textures: Firearms Source team
/ Animations: MyZombieKillerz
/ Sounds: New World Interactive, Hareno Antyo, D.N.I.O. 071 (Conversion to .ogg format, Edits by R4to0)
...
// Models
string W_MODEL = "models/ins2/wpn/g3a3/w_g3a3.mdl";
string V_MODEL = "models/ins2/wpn/g3a3/v_g3a3.mdl";
string P_MODEL = "models/ins2/wpn/g3a3/p_g3a3.mdl";
string A_MODEL = "models/ins2/ammo/mags.mdl";
int MAG_BDYGRP = 15;
// Sprites
string SPR_CAT = "ins2/brf/"; //Weapon category used to get the sprite's location
// Sounds
string SHOOT_S = "ins2/wpn/g3a3/shoot.ogg";
// Information
int MAX_CARRY   	= 150;
int MAX_CLIP    	= 20;
...
class weapon_ins2g3a3 : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase
{
	...
	private array<string> Sounds = {
		"ins2/wpn/g3a3/bltbk.ogg",
		"ins2/wpn/g3a3/bltrel.ogg",
		"ins2/wpn/g3a3/magin.ogg",
		"ins2/wpn/g3a3/magout.ogg",
	...
	bool Deploy()
	{
		...
		{
			m_WasDrawn = true;
			return Deploy( V_MODEL, P_MODEL, DRAW_FIRST, "m16", GetBodygroup(), (55.0/30.0) );
		}
		else
	...
	void PrimaryAttack()
	{
		...
		ShootWeapon( SHOOT_S, 1, VecModAcc( VECTOR_CONE_1DEGREES, 2.0f, 0.65f, 1.75f ), (m_pPlayer.pev.waterlevel == WATERLEVEL_HEAD) ? 1024 : 10240, DAMAGE, true );
	...
	void Reload()
	{
		...
		{
			(self.m_iClip == 0) ? Reload( MAX_CLIP, RELOAD_EMPTY, (135.0/30.0), GetBodygroup() ) : Reload( MAX_CLIP, RELOAD, (92.0/30.0), GetBodygroup() );
			canReload = false;
		}
...
class G3A3_MAG : ScriptBasePlayerAmmoEntity, INS2BASE::AmmoBase
{
	void Spawn()
	{
		Precache();
...
string GetAmmoName()
{
	return "ammo_ins2g3a3";
}

string GetName()
{
	return "weapon_ins2g3a3";
}

void Register()
{
	g_CustomEntityFuncs.RegisterCustomEntity( "INS2_G3A3::weapon_ins2g3a3", GetName() ); // Register the weapon entity
	g_CustomEntityFuncs.RegisterCustomEntity( "INS2_G3A3::G3A3_MAG", GetAmmoName() ); // Register the ammo entity
