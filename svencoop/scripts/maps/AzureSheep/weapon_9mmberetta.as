...
const int BERETTA_DEFAULT_GIVE = 12;
const int BERETTA_MAX_CARRY = 250;
const int BERETTA_MAX_CLIP = 12;
...
class weapon_9mmberetta : ScriptBasePlayerWeaponEntity
{
	...
	int m_iShotsFired;
	int m_fInAttack;
	int m_iBulletDamage = Math.RandomLong( 16, 17 );
	...
	void Precache()
	{
		...
		g_Game.PrecacheGeneric( "sprites/test/weapon_9mmberetta.txt" );
	}
...
void Register()
{
	g_CustomEntityFuncs.RegisterCustomEntity( "BERETTA::weapon_9mmberetta", GetBerettaName() ); // Register el arma como entidad
