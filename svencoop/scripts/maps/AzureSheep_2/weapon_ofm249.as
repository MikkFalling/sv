...
class weapon_ofm249 : ScriptBasePlayerWeaponEntity
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "models/mikk/azuresheep/v_saw.mdl" );
	...
	bool Deploy()
	{
		...
		m_fM249Reload = false;
		UpdateTape();
		return self.DefaultDeploy( self.GetV_Model( "models/mikk/azuresheep/v_saw.mdl" ), self.GetP_Model( "models/hlclassic/p_saw.mdl" ), M249_DEPLOY, "saw", 0, self.pev.body );
	}
