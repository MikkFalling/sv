...
const int GLUON_DAMAGE = Math.RandomLong(80 , 85); // for primary fire

const int GLUON_DAMAGE_ALT = Math.RandomLong(90 , 120); // for secondary fire
...
class CGluon : ScriptBaseEntity
{
	...
	void ExplodeTouch( CBaseEntity@ pOther )
	{
		...
		NetworkMessage beamcylinder1( MSG_PVS, NetworkMessages::SVC_TEMPENTITY );
			...
			beamcylinder1.WriteCoord( self.pev.origin.x );
			beamcylinder1.WriteCoord( self.pev.origin.y );
			beamcylinder1.WriteCoord( self.pev.origin.z + 80 );
		...
		NetworkMessage beamcylinder2( MSG_PVS, NetworkMessages::SVC_TEMPENTITY );
			...
			beamcylinder2.WriteCoord( self.pev.origin.x );
			beamcylinder2.WriteCoord( self.pev.origin.y );
			beamcylinder2.WriteCoord( self.pev.origin.z + 160 );
		...
		NetworkMessage beamcylinder3( MSG_PVS, NetworkMessages::SVC_TEMPENTITY );
			...
			beamcylinder3.WriteCoord( self.pev.origin.x );
			beamcylinder3.WriteCoord( self.pev.origin.y );
			beamcylinder3.WriteCoord( self.pev.origin.z + 240 );
		...
		g_WeaponFuncs.RadiusDamage(	self.pev.origin, self.pev, pevOwner, self.pev.dmg, 140, CLASS_NONE, DMG_ENERGYBEAM);
	...
	void ExplodeTouchAlt( CBaseEntity@ pOther )
	{
		...
		NetworkMessage beamcylinder1alt( MSG_PVS, NetworkMessages::SVC_TEMPENTITY );
			beamcylinder1alt.WriteByte( TE_BEAMCYLINDER );
			beamcylinder1alt.WriteCoord( self.pev.origin.x );
			beamcylinder1alt.WriteCoord( self.pev.origin.y );
			beamcylinder1alt.WriteCoord( self.pev.origin.z + offsetz );
			beamcylinder1alt.WriteCoord( self.pev.origin.x );
			beamcylinder1alt.WriteCoord( self.pev.origin.y );
			beamcylinder1alt.WriteCoord( self.pev.origin.z + 160 );
			beamcylinder1alt.WriteShort( m_iRingTexture );
			beamcylinder1alt.WriteByte( 0 );
			beamcylinder1alt.WriteByte( 0 );
			beamcylinder1alt.WriteByte( discLife );
			beamcylinder1alt.WriteByte( discWidth );
			beamcylinder1alt.WriteByte( 0 );
			beamcylinder1alt.WriteByte( int(discR) );
			beamcylinder1alt.WriteByte( int(discG) );
			beamcylinder1alt.WriteByte( int(discB) );
			beamcylinder1alt.WriteByte( int(discBrightness) );
			beamcylinder1alt.WriteByte( 0 );
		beamcylinder1alt.End();
		
		NetworkMessage beamcylinder2alt( MSG_PVS, NetworkMessages::SVC_TEMPENTITY );
			beamcylinder2alt.WriteByte( TE_BEAMCYLINDER );
			beamcylinder2alt.WriteCoord( self.pev.origin.x );
			beamcylinder2alt.WriteCoord( self.pev.origin.y );
			beamcylinder2alt.WriteCoord( self.pev.origin.z + offsetz );
			beamcylinder2alt.WriteCoord( self.pev.origin.x );
			beamcylinder2alt.WriteCoord( self.pev.origin.y );
			beamcylinder2alt.WriteCoord( self.pev.origin.z + 320 );
			beamcylinder2alt.WriteShort( m_iRingTexture );
			beamcylinder2alt.WriteByte( 0 );
			beamcylinder2alt.WriteByte( 0 );
			beamcylinder2alt.WriteByte( discLife );
			beamcylinder2alt.WriteByte( discWidth );
			beamcylinder2alt.WriteByte( 0 );
			beamcylinder2alt.WriteByte( int(discR) );
			beamcylinder2alt.WriteByte( int(discG) );
			beamcylinder2alt.WriteByte( int(discB) );
			beamcylinder2alt.WriteByte( int(discBrightness) );
			beamcylinder2alt.WriteByte( 0 );
		beamcylinder2alt.End();
		
		NetworkMessage beamcylinder3alt( MSG_PVS, NetworkMessages::SVC_TEMPENTITY );
			beamcylinder3alt.WriteByte( TE_BEAMCYLINDER );
			beamcylinder3alt.WriteCoord( self.pev.origin.x );
			beamcylinder3alt.WriteCoord( self.pev.origin.y );
			beamcylinder3alt.WriteCoord( self.pev.origin.z + offsetz);
			beamcylinder3alt.WriteCoord( self.pev.origin.x );
			beamcylinder3alt.WriteCoord( self.pev.origin.y );
			beamcylinder3alt.WriteCoord( self.pev.origin.z + 480 );
			beamcylinder3alt.WriteShort( m_iRingTexture );
			beamcylinder3alt.WriteByte( 0 );
			beamcylinder3alt.WriteByte( 0 );
			beamcylinder3alt.WriteByte( discLife );
			beamcylinder3alt.WriteByte( discWidth );
			beamcylinder3alt.WriteByte( 0 );
			beamcylinder3alt.WriteByte( int(discR) );
			beamcylinder3alt.WriteByte( int(discG) );
			beamcylinder3alt.WriteByte( int(discB) );
			beamcylinder3alt.WriteByte( int(discBrightness) );
			beamcylinder3alt.WriteByte( 0 );
		beamcylinder3alt.End();
		...
		g_WeaponFuncs.RadiusDamage(	self.pev.origin, self.pev, pevOwner, self.pev.dmg, 330, CLASS_NONE, DMG_ENERGYBEAM);
	...
	void Spawn()
	{
		...
		self.pev.rendercolor = Vector(0,0,245);
	...
	void FlyAlt()
	{
		int ralt=215, galt=35, balt=255, bralt=128;
		int r2alt=255, g2alt=0, b2alt=255, br2alt=64;
		...
		NetworkMessage ntrail2( MSG_PVS, NetworkMessages::SVC_TEMPENTITY );
			...
			ntrail2.WriteShort( m_iTrail  );
			ntrail2.WriteByte( Math.RandomLong(5,30) );//Life
			ntrail2.WriteByte( Math.RandomLong(8,10) );//Width
			ntrail2.WriteByte( int(ralt) );
			ntrail2.WriteByte( int(galt) );
			ntrail2.WriteByte( int(balt) );
			ntrail2.WriteByte( int(bralt) );
		ntrail2.End();
...
CGluon@ ShootGluon( entvars_t@ pevOwner, Vector vecStart, Vector vecVelocity, bool m_bSecondaryFire, int iWastedAmmo )
{
	...
	if ( m_bSecondaryFire )
	{
		...
		pGluon.pev.dmg = GLUON_DAMAGE_ALT * iWastedAmmo;
