...
class checkpoint_spawner : ScriptBaseEntity
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "sprites/mikk/cp/glow01.spr" );

		g_Game.PrecacheGeneric( "sprites/mikk/cp/glow01.spr" );

		g_SoundSystem.PrecacheSound( "mikk/cp/particle_suck2.wav" );
	...
	void Use(CBaseEntity@ pActivator, CBaseEntity@ pCaller, USE_TYPE useType, float flValue)
	{
		if( g_SurvivalMode.IsActive() )
		{
			...
			NetworkMessage m( MSG_BROADCAST, NetworkMessages::SVC_TEMPENTITY, null );
				...
				m.WriteShort( g_EngineFuncs.ModelIndex( "sprites/mikk/cp/glow01.spr" ) );
				m.WriteShort( 0 );
			m.End();
	...
	void SpawnSnd()
	{
		g_SoundSystem.EmitSound( self.edict(), CHAN_ITEM, "mikk/cp/particle_suck2.wav", 1.0f, ATTN_NORM );
	}
	...
	void SpawnCheckpoint()
	{
		...
		g_SoundSystem.EmitSound( self.edict(), CHAN_ITEM, "mikk/cp/beamstart7.wav", 1.0f, ATTN_NORM );
