...
string V_MODEL = "models/ins2/wpn/kabar/v_kabar.mdl";
...
class weapon_ins2kabar : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase, INS2BASE::MeleeWeaponBase
{
	...
	void DoHeavyAttack()
	{
		Smack( 44.0, (16.0/30.0), DAMAGE, (26.0/30.0), KnifeHitFlesh[Math.RandomLong( 0, KnifeHitFlesh.length() - 1)], BayoHitWorld[Math.RandomLong( 0, BayoHitWorld.length() - 1)], DMG_SLASH | DMG_CLUB );
