...
class weapon_ofsniperrifle : ScriptBasePlayerWeaponEntity
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "models/cm_v3/op4/v_m40a1.mdl" );
	...
	bool Deploy()
	{
		...
		m_fSniperReload = false;
		return self.DefaultDeploy( self.GetV_Model( "models/cm_v3/op4/v_m40a1.mdl" ), self.GetP_Model( "models/hlclassic/p_m40a1.mdl" ), SNIPER_DRAW, "sniper", 0 );
	}
