...
class weapon_ofm249 : ScriptBasePlayerWeaponEntity
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "models/cm_v3/op4/v_saw.mdl" );
	...
	bool Deploy()
	{
		...
		m_fM249Reload = false;
		UpdateTape();
		return self.DefaultDeploy( self.GetV_Model( "models/cm_v3/op4/v_saw.mdl" ), self.GetP_Model( "models/hlclassic/p_saw.mdl" ), M249_DEPLOY, "saw", 0, self.pev.body );
	}
