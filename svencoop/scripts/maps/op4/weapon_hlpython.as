...
class weapon_hlpython : ScriptBasePlayerWeaponEntity
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "models/cm_v3/op4/v_357.mdl" );
	...
	bool Deploy()
	{
		...
		return self.DefaultDeploy( self.GetV_Model( "models/cm_v3/op4/v_357.mdl" ), self.GetP_Model( "models/hlclassic/p_357.mdl" ), PYTHON_DRAW, "python", 0, self.pev.body );
	}
