...
class weapon_hlmp5 : ScriptBasePlayerWeaponEntity
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "models/cm_v3/op4/v_9mmAR.mdl" );
	...
	bool Deploy()
	{
		return self.DefaultDeploy( self.GetV_Model( "models/cm_v3/op4/v_9mmAR.mdl" ), self.GetP_Model( "models/hlclassic/p_9mmAR.mdl" ), MP5_DEPLOY, "mp5" );
	}
...
void RegisterHLMP5()
{
	...
	g_ItemRegistry.RegisterWeapon( GetHLMP5Name(), "hl_weapons", "9mm", "ARgrenades", "ammo_9mmAR", "ammo_ARgrenades");
}
