...
string V_MODEL = "models/ins2/wpn/stg44/v_stg44.mdl";
...
uint SLOT       	= 5;
uint POSITION   	= 14;
float RPM_AIR   	= 575; //Rounds per minute in air
...
class weapon_ins2stg44 : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase
{
	...
	bool Deploy()
	{
		...
		{
			m_WasDrawn = true;
			return Deploy( V_MODEL, P_MODEL, DRAW_FIRST, "m16", GetBodygroup(), (69.0/35.0) );
		}
		else
			return Deploy( V_MODEL, P_MODEL, DRAW, "m16", GetBodygroup(), (22.0/32.0) );
	}
	...
	{
		if( WeaponADSMode == INS2BASE::IRON_IN )
			ChangeFireMode( IRON_FIRESELECT, GetBodygroup(), INS2BASE::SELECTFIRE_AUTO, INS2BASE::SELECTFIRE_SEMI, (30.0/30.0) );
		else
			ChangeFireMode( FIRESELECT, GetBodygroup(), INS2BASE::SELECTFIRE_AUTO, INS2BASE::SELECTFIRE_SEMI, (25.0/30.0) );
		...
		{
			(self.m_iClip == 0) ? Reload( MAX_CLIP, RELOAD_EMPTY, (160.0/35.0), GetBodygroup() ) : Reload( MAX_CLIP, RELOAD, (98.0/35.0), GetBodygroup() );
			canReload = false;
		}
