...
class CGluongun : ScriptBasePlayerWeaponEntity
{
	...
	void SecondaryAttack()
	{
		...
		else
		{
			...
			if ( WeaponTimeBase() >= m_flNextAmmoBurn && m_flNextAmmoBurn != 800 )
			{
	...
	void StartFire()
	{
		...
		ShootGluon( basePlayer.pev, basePlayer.pev.origin + basePlayer.pev.view_ofs + g_Engine.v_forward * 12 + g_Engine.v_right * 3 + g_Engine.v_up * -8, g_Engine.v_forward * (m_iWastedAmmo*280) , true , m_iWastedAmmo );
