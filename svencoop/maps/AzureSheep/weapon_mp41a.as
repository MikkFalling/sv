...
const int MP5_MAX_CLIP2		= 2;
const int MP5_MAX_CLIP 		= 50;
const int MP5_WEIGHT 		= 5;

class weapon_mp41a : ScriptBasePlayerWeaponEntity
{
	...
	{
		Precache();
		g_EntityFuncs.SetModel( self, "models/mikk/azuresheep/w_9mm41a.mdl" );
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "models/mikk/azuresheep/w_9mm41a.mdl" );
		g_Game.PrecacheModel( "models/mikk/azuresheep/p_9mm41a.mdl" );
		...
		g_Game.PrecacheGeneric( "sprites/mikk/weapon_mp41a.txt" );
	...
	bool Deploy()
	{
		bool fResult = self.DefaultDeploy( self.GetV_Model( "models/mikk/azuresheep/v_9mmm41a.mdl" ), self.GetP_Model( "models/mikk/azuresheep/p_9mm41a.mdl" ), MP5_DEPLOY, "mp5" );
	...
	void Reload()
	{
		self.DefaultReload( MP5_MAX_CLIP, MP5_RELOAD, 1.645, 0 );
...
void RegisterHLMP5()
{
	g_CustomEntityFuncs.RegisterCustomEntity( "weapon_mp41a", GetHLMP5Name() );
	g_ItemRegistry.RegisterWeapon( GetHLMP5Name(), "test", "9mm", "ARgrenades", "ammo_9mmAR", "ammo_ARgrenades" );
}
